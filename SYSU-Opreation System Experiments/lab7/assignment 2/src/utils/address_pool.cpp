...
void AddressPool::FirstFit(int ProcessSize[4])
{
  resources.FirstFit(ProcessSize);
}
void AddressPool::BestFit(int ProcessSize[4])
{
  resources.BestFit(ProcessSize);
}
...
void AddressPool::PrintSpace()
{
  resources.PrintSpace();
}
