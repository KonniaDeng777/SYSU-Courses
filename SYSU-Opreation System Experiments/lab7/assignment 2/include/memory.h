...
public:
    ...
    // 获取内存总容量
    int getTotalMemory();
    void PrintSpace(enum AddressPoolType type);
    void FirstFit(int ProcessSize[4], enum AddressPoolType type);
    void BestFit(int ProcessSize[4],enum AddressPoolType type);    
};
#endif
