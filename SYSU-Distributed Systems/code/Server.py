...
PROMPTING_MESSAGE = {
    ...
    4: 'Error: Can not access the file.',
    5: 'Error: Free lock failed.',
    6: 'Error: No such directory.'
}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--port', type=int, default=12341, help='port')
