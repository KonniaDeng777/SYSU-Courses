...
class ProxyServer(rpyc.Service):
    ...
    # Master handles the download request
    ...
    # Master handles the upload request
    ...
    # Master handles the delete request
    ...
    # Master handles the find request
    ...
    # Master handles the list request
    ...
    # Master handles releasing read locks
    ...
    # Master establishes a connection with the user
    ...
    # Master disconnects from the user
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n', type=int, default=5, help='n')
