...
class BookForm(FlaskForm):
    ...
    check_in = DateField('Check in date, eg: 2023-12-01', format='%Y-%m-%d', validators=[validators.DataRequired()])
    check_out = DateField('Check out date, eg: 2024-12-31', format='%Y-%m-%d', validators=[validators.DataRequired()])
...
class RoomQueryForm(FlaskForm):
    ...
    begin_date = DateField('Date From, eg: 2023-12-01', format='%Y-%m-%d', validators=[validators.Optional()])
    to_date = DateField('Date To, eg: 2024-12-31', format='%Y-%m-%d', validators=[validators.Optional()])
...
class BookUpdateQueryForm(FlaskForm):
    ...
    g_id = IntegerField('Guest ID', validators=[validators.Optional()])
    r_id = IntegerField('Room ID', validators=[validators.Optional()])
    check_in = DateField('Check in date, eg: 2023-12-01', format='%Y-%m-%d', validators=[validators.Optional()])
    check_out = DateField('Check out date, eg: 2024-12-31', format='%Y-%m-%d', validators=[validators.Optional()])
